...
import { Grid, Box, IconButton, Tooltip, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Button, Typography } from '@mui/material';
...
const SavedEvents = () => {
    ...
    useEffect(() => {
        if (user) {
            const q = query(collection(db, 'savedEvents'), where('userId', '==', user.uid));
    ...
    return (
        <Box display="flex" justifyContent="center" marginTop={2}>
            ...
            <Dialog open={openDialog} onClose={handleDialogClose}>
                ...
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to unsave this event? This action cannot be undone.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
